...
app.get("/get/all", (req, res) => {
  return res
    .status(200)
    .json({ ids: [1370, 1369, 1490, 1426, 1480, 1410, 937, 995, 985, 1020, 1082, 1031, 1620, 1612, 1609, 1332] });
});
app.get("/get/cse", (req, res) => {
  return res.status(200).json({ ids: [1370, 1369, 1490, 1426, 1480, 1410, 1332] });
});
